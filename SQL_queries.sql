...
SELECT 
    ...
    SUM(a.current_balance * a.interest_rate) as annual_interest_income,
    COUNT(CASE WHEN a.current_balance > 10000 THEN 1 END) as high_balance_accounts,
    ROUND(COUNT(CASE WHEN a.current_balance > 10000 THEN 1 END) * 100.0 / COUNT(*), 2) as high_balance_percentage,
